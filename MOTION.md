...
| Celular (< 860 px) | Empilhamento mantido, mas sem esmaecer: o cartão preso só encolhe de leve (scale 1 → .94) enquanto a próxima seção desliza por cima. Como as seções são mais altas que a tela, o fade fazia o fim do texto sumir antes de ser lido; sem ele, dá para voltar e ler. Regra reavaliada em rotação/redimensionamento real. |
